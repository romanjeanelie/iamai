(function (self) {
  ...
  var asm = (function (E, u, C) {
    ...
    function ei(E, se, V, te, fe, Be, Ce, Y, ae) {
        ...
        if ((D | 0) > 2) {
          ...
          do {
            ...
            do {
              r[(O + ((u * 2304) | 0) + (w << 2)) >> 2] =
                +r[(n + ((w + 407) << 2)) >> 2] -
                (+r[(n + ((w + 418) << 2)) >> 2] + +r[(n + ((w + 397) << 2)) >> 2]) * 1.7303260184043527e-17 -
                (+r[(n + ((w + 417) << 2)) >> 2] + +r[(n + ((w + 398) << 2)) >> 2]) * 0.017031719908118248 -
                (+r[(n + ((w + 416) << 2)) >> 2] + +r[(n + ((w + 399) << 2)) >> 2]) * 1.3495279640235235e-17 +
                (+r[(n + ((w + 415) << 2)) >> 2] + +r[(n + ((w + 400) << 2)) >> 2]) * 0.04180720075964928 -
                (+r[(n + ((w + 414) << 2)) >> 2] + +r[(n + ((w + 401) << 2)) >> 2]) * 6.732779685849225e-17 -
                (+r[(n + ((w + 413) << 2)) >> 2] + +r[(n + ((w + 402) << 2)) >> 2]) * 0.08763240277767181 -
                (+r[(n + ((w + 412) << 2)) >> 2] + +r[(n + ((w + 403) << 2)) >> 2]) * 3.0835000291318875e-17 +
                (+r[(n + ((w + 411) << 2)) >> 2] + +r[(n + ((w + 404) << 2)) >> 2]) * 0.1863476037979126 -
                (+r[(n + ((w + 410) << 2)) >> 2] + +r[(n + ((w + 405) << 2)) >> 2]) * 1.1044240253100168e-16 -
                (+r[(n + ((w + 409) << 2)) >> 2] + +r[(n + ((w + 406) << 2)) >> 2]) * 0.6276379823684692;
              w = (w + 1) | 0;
            } while ((w | 0) != 576);
      ...
      if ((D | 0) > 0) {
        ...
        do {
          ...
          if (
            (_ | 0) != 3
              ? ((u + n + (e[(z + (M << 4) + 8) >> 2] | 0)) | 0) == ((0 - (e[(z + (M << 4) + 12) >> 2] | 0)) | 0)
              : 0
          )
            n = 1;
          else x = 47;
      ...
      if (ee) {
        ...
        do {
          ...
          if (a > 0) {
            ...
            n = ~~(
              (((s < m ? m : s) * 2 - a) * 20) /
              (+(((e[(g + 1716 + (n << 2)) >> 2] | 0) + -1 + (e[(g + 1716 + (u << 2)) >> 2] | 0)) | 0) * a)
            );
            n = (n | 0) > 8 ? 8 : n & 255;
          } else n = 0;
          i[(O + u) >> 0] = n;
          ...
          do {
            ...
            if (le | ((e[(q + (w << 2)) >> 2] | 0) == 0)) {
              ...
              if (a > 0) {
                ...
                n = ~~(
                  (((s < m ? m : s) * 2 - a) * 20) /
                  (+(((e[(g + 3876 + (n << 2)) >> 2] | 0) + -1 + (e[(g + 3876 + (u << 2)) >> 2] | 0)) | 0) * a)
                );
                n = (n | 0) > 8 ? 8 : n & 255;
              } else n = 0;
              i[(O + u) >> 0] = n;
    ...
    function $r(M) {
      ...
      if ((e[p >> 2] | 0) > 0) {
        ...
        do {
          ...
          s = s > 6 ? 30 : s;
          r[(B + (E << 2)) >> 2] = +(f | 0) * +d(10, +((e[D >> 2] | 0) < 44e3 ? 2.2 : ((s < u ? u : s) + -8) * 0.1));
          E = (E + 1) | 0;
        } while ((E | 0) < (e[p >> 2] | 0));
      }
      A = (h + 2160) | 0;
      ...
      if ((a | 0) > 0) {
        ...
        if ((a | 0) > 0) {
          ...
          while (1) {
            ...
            u = s > 6 ? 30 : s;
            r[(E + (_ << 2)) >> 2] = +(f | 0) * +d(10, +((e[D >> 2] | 0) < 44e3 ? 2.2 : ((u < m ? m : u) + -8) * 0.1));
            _ = (_ + 1) | 0;
            a = e[C >> 2] | 0;
            if ((_ | 0) >= (a | 0)) break;
            else a = o;
          ...
          do {
            ...
            if ((a | 0) > 0) {
              ...
              do {
                ...
                Se(n, f);
                a =
                  (J(n, (k + ((w * 976) | 0) + ((i * 488) | 0)) | 0, f, (z + ((w * 312) | 0) + ((i * 156) | 0)) | 0) |
                    0) ==
                  0;
                o = a ? o : 0;
                e[(U + (w << 3) + (i << 2)) >> 2] = 126;
              ...
              while (1) {
                ...
                if (
                  (e[(n + 304 + ((a * 10504) | 0) + ((o * 5252) | 0) + 4788) >> 2] | 0) == 2
                    ? ((W = e[(n + 304 + ((a * 10504) | 0) + ((o * 5252) | 0) + 4852) >> 2] | 0), (W | 0) < 13)
                    : 0
                ) {
                  i = W;
                  while (1) {
        ...
        do {
          ...
          if ((a | 0) > 0) {
            ...
            do {
              ...
              Se(i, a);
              a =
                (J(i, (L + ((m * 976) | 0) + ((p * 488) | 0)) | 0, a, (N + ((m * 312) | 0) + ((p * 156) | 0)) | 0) |
                  0) ==
                0;
              l = a ? l : 0;
          ...
          if (L) {
            ...
            do {
              ...
              if (w > 700) {
                ...
                o = ((o | 0) < (f | 0) ? (e[(n + 304 + ((v * 10504) | 0) + ((i * 5252) | 0) + 4788) >> 2] | 0) == 2 : 0)
                  ? f
                  : o;
              ...
              if ((e[R >> 2] | 0) > 0) {
                ...
                do {
                  ...
                  r[L >> 2] = +d(
                    10,
                    +(
                      +r[((e[(n + 304 + ((a * 10504) | 0) + ((i * 5252) | 0) + 4788) >> 2] | 0) == 2 ? h : _) >> 2] *
                      0.1
                    )
                  );
                  Se(n, l);
      ...
      do {
        ...
        if ((e[y >> 2] | 0) > 0) {
          ...
          do {
            ...
            r[F >> 2] = +d(
              10,
              +(+r[((e[(i + 304 + ((n * 10504) | 0) + ((o * 5252) | 0) + 4788) >> 2] | 0) == 2 ? O : R) >> 2] * 0.1)
            );
            Se(i, s);
            r[_ >> 2] = 0;
          ...
          do {
            ...
            if (!(+r[(C + (E << 2)) >> 2] < d)) {
              if (
                (
                  ((e[$ >> 2] & 2) | 0) != 0
                    ? ((R = (v + 84936 + (E << 2)) | 0), (w = (e[R >> 2] | 0) == 0), (e[R >> 2] = w & 1), !w)
                    : 0
                )
                  ? (e[W >> 2] | 0) == 2
                  : 0
                ...
                do
                  if ((_ | 0) == 130) {
                    ...
                    if (d > 0) {
                      ...
                      if ((f > -0.1) & (f > a + -0.15)) i = +r[g >> 2] * 2 + +r[A >> 2] < +r[k >> 2] * 2 + +r[D >> 2];
                      else i = 0;
                    } else i = 0;
                  }
                while (0);
    ...
    function ye(e, r, i, t) {
      ...
      return +(+d(
        10,
        +((i + 90.30873107910156 + (t < 1 ? -94.82444763183594 : -t) + (e < 0 ? 0 : e) * r) * 0.10000000149011612)
      ));
    }
    function J(S, v, h, f) {
      S = S | 0;
      ...
      if ((e[O >> 2] | 0) > 0) {
        ...
        while (1) {
          ...
          l = +d(
            10,
            +((c + 90.30873107910156 + (o < 1 ? -94.82444763183594 : -o) + (l < 0 ? 0 : l) * n) * 0.10000000149011612)
          );
          M = +r[(S + 84768 + (a << 2)) >> 2];
          l = M * l;
          m = e[(h + 4872 + (a << 2)) >> 2] | 0;
      ...
      while (1) {
        ...
        u = +d(
          10,
          +((c + 90.30873107910156 + (l < 1 ? -94.82444763183594 : -l) + (n < 0 ? 0 : n) * t) * 0.10000000149011612)
        );
        R = (S + 84856 + (_ << 2)) | 0;
        l = +r[R >> 2];
        u = l * u;
        ...
        if ((d | 0) > 0) {
          ...
          do {
            ...
            if (y ? ((x = e[(u + 304 + ((o * 10504) | 0) + ((i * 5252) | 0) + 4852) >> 2] | 0), (x | 0) < 13) : 0) {
              ...
              while (1) {
                ...
                if ((T | 0) <= (A | 0)) {
                  ...
                  if (C)
                    f[a >> 3] =
                      n - +(e[(u + 304 + ((o * 10504) | 0) + ((i * 5252) | 0) + 4608 + (d << 2)) >> 2] | 0) * R;
                  c = (d + 1) | 0;
                  a = (g + 1) | 0;
                  ...
                  if (C)
                    f[a >> 3] =
                      n - +(e[(u + 304 + ((o * 10504) | 0) + ((i * 5252) | 0) + 4608 + (c << 2)) >> 2] | 0) * R;
                  c = (d + 2) | 0;
                  a = (g + 2) | 0;
                  f[(w + 194616 + ((o * 1248) | 0) + ((i * 312) | 0) + (a << 3)) >> 3] = 9999999747378752e-21;
                  f[(w + 201912 + ((o * 624) | 0) + ((i * 312) | 0) + (a << 3)) >> 3] =
                  ...
                  while (1) {
                    ...
                    if (C)
                      f[c >> 3] =
                        n - +(e[(u + 304 + ((o * 10504) | 0) + ((i * 5252) | 0) + 4608 + (m << 2)) >> 2] | 0) * R;
                    a = (a + 1) | 0;
                    if ((a | 0) == 3) break;
                    else m = (m + 1) | 0;
                  }
            ...
            e[(d + 203400 + (o << 3) + (i << 2)) >> 2] =
              (e[c >> 2] | 0) + (e[(u + 304 + ((o * 10504) | 0) + ((i * 5252) | 0) + 4768) >> 2] | 0);
    ...
    function oe(p, r) {
      ...
      if ((s | 0) > (c | 0)) {
        ...
        do {
          ...
          s = (s + -4) | 0;
          S =
            ((((((e[(r + 2304 + (s << 2)) >> 2] << 1) + (e[(r + 2304 + ((S + -3) << 2)) >> 2] | 0)) << 1) +
              (e[(r + 2304 + ((S + -2) << 2)) >> 2] | 0)) <<
              1) +
              (e[(r + 2304 + ((S + -1) << 2)) >> 2] | 0)) |
            0;
    ...
    function I(y, k, f, w) {
      ...
      if (
        ((e[(y + 85096) >> 2] & 2) | 0) != 0
          ? ((P = 0.634521682242439 / +r[(79704 + (((e[A >> 2] | 0) + (e[O >> 2] | 0)) << 2)) >> 2]),
            (T = (f + 4860) | 0),
            (v = e[T >> 2] | 0),
            (v | 0) > 0)
          : 0
    ...
    function Oe(g, d, n, t) {
      ...
      e[(h + 12) >> 2] = 0;
      if (
        (((d | 0) == 1 ? (e[(g + 76) >> 2] | 0) == 2 : 0) ? (e[(t + ((n * 5252) | 0) + 4788) >> 2] | 0) != 2 : 0)
    ...
    function We(w, i) {
      ...
      if ((e[(w + 76) >> 2] | 0) == 2) {
        ...
        do {
          if (
            ((u | 0) < (e[(88776 + (r << 2)) >> 2] | 0) ? (n | 0) < (e[(88840 + (r << 2)) >> 2] | 0) : 0)
    ...
    function L(o, i) {
      ...
      switch (e[(o + 192) >> 2] | 0) {
        ...
        case 1: {
          ...
          n = i + -3.4;
          t = i + -8.7;
          i = +d(+i, -0.8) * 3.64 - +v(+(n * n * -0.6)) * 6.8 + +v(+(t * t * -0.15)) * 6 + +d(+i, 4) * 56e-5;
          return +i;
        }
        case 4: {
          i = i < -0.3 ? 3.4100000858306885 : i * 0.0010000000474974513;
        ...
        case 2: {
          ...
          n = i + -3.4;
          t = i + -8.7;
          i = +d(+i, -0.8) * 3.64 - +v(+(n * n * -0.6)) * 6.8 + +v(+(t * t * -0.15)) * 6 + +d(+i, 4) * 6e-4;
          return +i;
        }
        default: {
          i = i < -0.3 ? 3.4100000858306885 : i * 0.0010000000474974513;
            ...
            while (1) {
              ...
              while (1) {
                ...
                if (+p(+S) < 1e-9) a = Y;
                  ...
                  a =
                    ((0.42 - +N(+(a * 2 * 3.141592653589793)) * 0.5 + +N(+(a * 4 * 3.141592653589793)) * 0.08) *
                      +Lr(+(F * S))) /
                    (G * S);
                r[(n + (h << 2)) >> 2] = a;
                d = a + d;
          ...
          if (W) {
            ...
            do {
              ...
              while (1) {
                O = (w + h) | 0;
                d =
                  +r[(i + (w << 2)) >> 2] * +r[((O | 0) < 0 ? (g + ((O + _) << 2)) | 0 : (P + (O << 2)) | 0) >> 2] + d;
                if ((w | 0) < (s | 0)) w = (w + 1) | 0;
                else break;
              }
              r[(K + ((o + B) << 2)) >> 2] = d;
    ...
    function Et(u) {
            ...
            if ((d | 0) > 0) {
              ...
              do {
                ...
                e: do
                  if ((r | 0) > 0) {
                    if ((R | 0) > 0) {
                      ...
                      while (1) {
                        d =
                          (((e[(u + 304 + ((b * 10504) | 0) + ((S * 5252) | 0) + 4608 + (a << 2)) >> 2] | 0) == -1
                            ? 0
                            : R) +
                            d) |
                          0;
                ...
                if ((e[(u + 304 + ((b * 10504) | 0) + ((S * 5252) | 0) + 4788) >> 2] | 0) == 2) {
                  ...
                  a =
                    ((O(u, e[(u + 304 + ((b * 10504) | 0) + ((S * 5252) | 0) + 4800) >> 2] | 0, h, e[f >> 2] | 0, F) |
                      0) +
                      a) |
                    0;
                } else {
                  ...
                  f =
                    e[
                      (u +
                        21360 +
                        ((f + 2 + (e[(u + 304 + ((b * 10504) | 0) + ((S * 5252) | 0) + 4828) >> 2] | 0)) << 2)) >>
                        2
                    ] | 0;
                  y = (y | 0) > (a | 0) ? a : y;
                  f = (f | 0) > (a | 0) ? a : f;
                  ...
                  h =
                    ((O(u, e[(u + 304 + ((b * 10504) | 0) + ((S * 5252) | 0) + 4800) >> 2] | 0, y, f, F) | 0) + h) | 0;
                  a =
                    (h + (O(u, e[(u + 304 + ((b * 10504) | 0) + ((S * 5252) | 0) + 4804) >> 2] | 0, f, a, F) | 0)) | 0;
                }
                n = (d + n + a + (lr(u, F) | 0)) | 0;
                S = (S + 1) | 0;
                d = e[I >> 2] | 0;
      ...
      m =
        ((((((s((((r * 72e3) | 0) + 72e3) | 0, e[n >> 2] | 0) | 0) / (e[j >> 2] | 0)) | 0) + (e[q >> 2] | 0)) << 3) +
          m) |
        0;
      if ((m | 0) < 0) M(u, 1072, G);
      n = (u + 52140) | 0;
    ...
    function sr(a, g, A, G, Y) {
      ...
      D = (a + 140) | 0;
      if (
        ((e[D >> 2] | 0) != 0 ? ((p = (a + 85804) | 0), (e[p >> 2] | 0) != 0) : 0)
          ? ((h = e[S >> 2] | 0), (h | 0) > 0)
          : 0
      ) {
        d = (a + 72) | 0;
                  ...
                  ((re + R) * 3.8980449615198e-17 +
                    ((X + te) * -0.1559150069952011 +
                      ((ne + oe) * -0.21623599529266357 +
                        ((ae + _) * -0.18920649588108063 + ((O + v) * -0.10394349694252014 + F)))))))));
        if (d & ((g | 0) > 0)) {
          o = 0;
          do {
            h = 0;
    ...
    function tr(n, r) {
      ...
      if (!(((((t & 255) << 24) >> 24 < 32 ? 32 : t) ^ (((e & 255) << 24) >> 24 < 32 ? 32 : e)) & 255)) {
        ...
        r = q((r << 24) >> 24) | 0;
        return (
          (((((((r & 255) << 24) >> 24 < 32 ? 32 : r) ^ (((e & 255) << 24) >> 24 < 32 ? 32 : e)) & 255) | 0) == 0) | 0
        );
      } else return 0;
      return 0;
    }
        ...
        if (!i) {
          ...
          if (((y | 0) == 4) | ((y | 0) == 1)) {
            ...
            while (1) {
              ...
              if (
                ((a | 0) >= (u | 0) ? ((x = +r[(6560 + ((m * 24) | 0) + 4) >> 2]), x <= F) : 0)
    ...
    function Or(i) {
      ...
      i = +ji(
        u +
          u *
            i *
            (i * (i * (i * (i * 0.0013333559164630223 + 0.009618129842126066) + 0.0555041086648214) + 0.2402265069591) +
              0.6931471805599453),
        (((o & -256) | 0) / 256) | 0
      );
      t = s;
        ...
        l *
          (r +
            (t * (t * (t * 0.15313837699209373 + 0.22222198432149784) + 0.3999999999940942) +
              u *
                (t * (t * (t * 0.14798198605116586 + 0.1818357216161805) + 0.2857142874366239) + 0.6666666666666735))) +
        (o - c - r);
      ...
      if ((t | 0) == 194) {
        ...
        e: do
          if (m) {
            ...
            if (
              ((t | 0) == 204 ? ((e[(z + 12) >> 2] & 8) | 0) == 0 : 0) ? (m >>> 0 < h >>> 0) & (m >>> 0 >= x >>> 0) : 0
            ) {
              e[U >> 2] = H + n;
              t = ((e[24125] | 0) + n) | 0;
              _ = (m + 8) | 0;
    ...
    function wi(e, r) {
      ...
      e = s(r, o) | 0;
      return (
        ((m = ((i >>> 16) + (s(r, n) | 0) + ((((i & 65535) + e) | 0) >>> 16)) | 0), ((i + e) << 16) | (t & 65535) | 0) |
        0
      );
    }
    function An(i, e, s, r) {
