...
exports.data = exports.slider2Data = exports.slider1Data = exports.heroData = void 0;
var heroData = ["TLDR", "Introducing CO* <br /> World’s First <br /> Personal AI Assistant.", "Revolutionise how you <br /> get things done.", "CO* converses <br class='mobile-break' /> naturally and <br class='desktop-break' /> tackles real-world tasks like a <br class='desktop-break' /> human assistant.", "Get instant answers. <br /> Not search results. ", "Experience true multitasking.", "CO* effortlessly <br class='sm-mobile-break' /> juggles multiple <br class='desktop-break' /> conversations and <br class='sm-mobile-break' /> tasks <br class='desktop-break' /> maximising <br class='sm-mobile-break' />  your time <br class='desktop-break' /> and efficiency.", "CO* is multilingual.<br/> Speaks several languages fluently.", "Powered by open-source <br class='desktop-break' /> innovation.", "Our expert fine-tuning <br class='sm-mobile-break' /> of LLaMA <br class='desktop-break' /> 70B  <br class='sm-mobile-break' /> model has <br /> created a powerful <br /> Personal AI Assistant.", "With <br /> Advanced planning. <br/> Advanced reasoning. <br />Task execution.", "CO* tackles <br class='sm-mobile-break' />  complex tasks. <br />  Breaks tasks down.<br /> Execute steps. <br /> Adapts on the fly <br class='sm-mobile-break' />  for <br class='desktop-break' /> successful completion.", "We all want more <br class='sm-mobile-break' />  time, less hassle.<br /> That's why we <br class='sm-mobile-break' />  created CO*", "Personal <br class='sm-mobile-break' />  AI Assistant <br class='sm-mobile-break' />  For Everyone."];
exports.heroData = heroData;
var slider1Data = [{
  id: 1,
  video: "https://res.cloudinary.com/dfdqiqn98/video/upload/q_auto:best/v1712325504/Desktop_Zoom_In_ChatGPT_q9c27m.mp4",
  videoMobile: "https://res.cloudinary.com/dfdqiqn98/video/upload/q_auto:best/v1712326125/Mobile_Zoom_In_ChatGPT_msk62g.mp4",
...
exports.slider1Data = slider1Data;
var slider2Data = [{
  id: 1,
...
exports.slider2Data = slider2Data;
var data = [{
  h1: "Talk. Not Search.",
  h4: "CO*",
  h4Span: "/’co-star:/",
