...
var DiscussionMediaManager =
  /*#__PURE__*/
  (function () {
    function DiscussionMediaManager(_ref) {
      var container = _ref.container,
        emitter = _ref.emitter;

      _classCallCheck(this, DiscussionMediaManager);
    ...
    _createClass(DiscussionMediaManager, [
      {
        key: "init",
        value: function init() {
      ...
      },
      {
        ...
        value: function addSources(sourcesData) {
          ...
          try {
            for (
              var _iterator = sourcesData[Symbol.iterator](), _step;
    ...
    return DiscussionMediaManager;
  })();

exports["default"] = DiscussionMediaManager;
