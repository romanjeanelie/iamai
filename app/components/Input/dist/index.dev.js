    ...
    _createClass(Input, [
      ...
      },
      {
        ...
        value: function onCompleteRecording(blob) {
          ...
          return regeneratorRuntime.async(
            function onCompleteRecording$(_context) {
              while (1) {
                switch ((_context.prev = _context.next)) {
                  ...
                  case 8:
                    ...
                    return regeneratorRuntime.awrap(
                      (0, _sendToWhisper["default"])(blob, this.discussion.Chat.sourcelang)
                    );
      ...
      },
      {
        ...
        value: function addListeners() {
          ...
          if (this.frontMicBtn)
            this.frontMicBtn.addEventListener("click", function () {
          ...
          this.longPress = new _longPress["default"](
            this.inputFrontEl,
