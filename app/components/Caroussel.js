...
import { sortArrayFromMiddleToEnds } from "../utils/sortArrayFromMiddleToEnds";
import anim from "../utils/anim";
import { colorMain, backgroundColorBluePage } from "../../scss/variables/_colors.module.scss";
...
export default class Caroussel {
  ...
  animLines(isShow) {
    ...
    if (this.middleLineIndex !== null && this.startAnimIndex === 0) {
      ...
      const animRight = animMask(maskRight, "100%", isShow);
      ...
      const animRight = animMask(mask1, "100%", isShow);
