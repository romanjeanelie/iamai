export default class HotelsUI {
  ...
  initUI() {
    ...
    hotelsdivfilterall.addEventListener("click", (event) => this.getHotelFilters(event, "all"));
    ...
    hotelsdivfilterairbnb.addEventListener("click", (event) => this.getHotelFilters(event, "airbnb"));
    ...
    hotelsdivfilterhotels.addEventListener("click", (event) => this.getHotelFilters(event, "accor"));
    hotelsdivfilter.appendChild(hotelsdivfilterhotels);
    this.hotelsContainer.appendChild(hotelsdivfilter);

    let hotelcardcontainerdiv = this.getHotelsCardsUI("all");

    this.hotelsContainer.appendChild(hotelcardcontainerdiv);
